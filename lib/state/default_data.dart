...
class DefaultData {
  ...
  static final projectInfo = <ProjectInfoEntry>[
    ProjectInfoEntry(id: 'pi1', category: 'General', label: 'Project Name', value: '24402 - Baptist Micro Hospital'),
    ProjectInfoEntry(id: 'pi2', category: 'General', label: 'Project Number', value: '24402'),
    ProjectInfoEntry(id: 'pi3', category: 'General', label: 'Project Address', value: '8350 Potranco Rd, San Antonio, TX 78251'),
    ProjectInfoEntry(id: 'pi4', category: 'General', label: 'Client', value: 'Baptist Health System'),
    ProjectInfoEntry(id: 'pi5', category: 'General', label: 'Architect of Record', value: 'A2H (Architecture to Health)'),
    ...
    ProjectInfoEntry(id: 'pi10', category: 'Codes & Standards', label: 'Healthcare Guidelines', value: 'FGI 2022 Guidelines for Design and Construction of Hospitals'),
    ProjectInfoEntry(id: 'pi11', category: 'Zoning', label: 'Zoning Classification', value: 'MF-33 Medical Facility'),
    ProjectInfoEntry(id: 'pi12', category: 'Zoning', label: 'FAR (Allowed / Designed)', value: '1.5 / 1.1'),
    ProjectInfoEntry(id: 'pi13', category: 'Zoning', label: 'Max Height', value: '45 ft (2 stories)'),
    ProjectInfoEntry(id: 'pi14', category: 'Zoning', label: 'Setbacks (F/S/R)', value: "25' / 15' / 25'"),
    ProjectInfoEntry(id: 'pi15', category: 'Site', label: 'Parcel Number', value: '05-3821-0047'),
    ProjectInfoEntry(id: 'pi16', category: 'Site', label: 'Lot Size', value: '4.2 acres (182,952 SF)'),
    ProjectInfoEntry(id: 'pi17', category: 'Site', label: 'Existing Use', value: 'Undeveloped / Agricultural'),
  ];
